...
export interface ZipPerdePageViewProps {
  galleryImages: string[]
  coverImage: string
}

/**
 * Zip Perde ana sayfası (istemci görünümü)
 */
export function ZipPerdePageView({ galleryImages, coverImage }: ZipPerdePageViewProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main>
        {/* Hero Section */}
        <ZipPerdeHero key={`hero-${language}`} imageSrc={coverImage} />
