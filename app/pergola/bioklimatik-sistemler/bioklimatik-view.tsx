...
export interface BioklimatikPageViewProps {
  galleryImages: string[]
  coverImage: string
}

/**
 * Bioklimatik Pergola Sistemleri Sayfası (istemci görünümü)
 */
export function BioklimatikPageView({ galleryImages, coverImage }: BioklimatikPageViewProps) {
