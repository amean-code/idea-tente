...
export interface PergolaPageViewProps {
  galleryImages: string[]
  coverImage: string
}

/**
 * Pergola Sistemleri ana sayfası (istemci görünümü)
 */
export function PergolaPageView({ galleryImages, coverImage }: PergolaPageViewProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main>
        ...
        <PergolaHero key={`hero-${language}`} imageSrc={coverImage} />
