...
export const getAllReferences = (t?: any): Reference[] => {
  ...
  // Kış Bahçesi Projeleri
  {
    ...
    image: "/luxury-winter-garden-interior-with-plants-and-furn.webp",
  ...
  // Zip Perde Projeleri
  {
    ...
    category: getCategory("Otel & Resort"),
    service: ["zip-screen"],
    image: "/zip-screen-vertical-blinds-on-outdoor-terrace--win.webp",
  ...
  // Karma Projeler
  {
    ...
    image: "/premium-pergola-luxury-outdoor-dining.webp",
